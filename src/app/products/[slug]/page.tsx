...
export default async function ProductPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const productSchema = {
    ...
    image: `https://globalchemsupply.com${product.image}`,
    sku: product.cas,
    brand: { "@type": "Brand", name: "GlobalChem Supply" },
    category: cat.name,
    offers: {
      "@type": "Offer",
      availability: "https://schema.org/InStock",
      priceCurrency: "USD",
      seller: { "@type": "Organization", name: "GlobalChem Supply" },
    },
    additionalProperty: [
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://globalchemsupply.com/" },
      { "@type": "ListItem", position: 2, name: cat.name, item: `https://globalchemsupply.com/category/${cat.id}` },
      { "@type": "ListItem", position: 3, name: product.name, item: `https://globalchemsupply.com/products/${product.slug}` },
    ],
  };
