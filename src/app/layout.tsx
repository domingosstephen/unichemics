...
export const metadata: Metadata = {
  metadataBase: new URL("https://globalchemsupply.com"),
  title: {
    template: "%s | GlobalChem Supply",
    default: "GlobalChem Supply — Industrial, Agricultural & Specialty Chemical Supplier",
  },
