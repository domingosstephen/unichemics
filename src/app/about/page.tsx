...
export const metadata: Metadata = {
  ...
  description: "Learn about SociedadeTeoflorChemi — a global chemical distribution company delivering quality-assured industrial, agricultural, and specialty chemicals to 50+ countries.",
    ...
    <>
      <section className="bg-gradient-to-br from-slate-900 to-slate-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold mb-3">About SociedadeTeoflorChemi</h1>
