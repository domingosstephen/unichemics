    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
      ...
      <div className="bg-slate-900 text-slate-400 text-xs py-1.5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center">
          ...
          <span><a href="https://wa.me/34631390443" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">+34 631 390 443</a> &nbsp;|&nbsp; <a href="mailto:contact@sociedadeteoflorchemi.com" className="hover:text-blue-400 transition-colors">contact@sociedadeteoflorchemi.com</a></span>
        </div>
      </div>
